...
import type { ExternalBlob as _ExternalBlob, Movie as _Movie, MovieId as _MovieId, MovieInput as _MovieInput, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMovie(arg0: MovieInput): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addMovie(await to_candid_MovieInput_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addToWatchlist(arg0: MovieId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getWatchlist(): Promise<Array<Movie>> {
        if (this.processError) {
            try {
    ...
    async removeFromWatchlist(arg0: MovieId): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Movie_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Movie): Promise<Movie> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        trailer: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.trailer),
        rating: value.rating,
        poster: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.poster)
    };
}
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Movie>): Promise<Array<Movie>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Movie_n14(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_MovieInput_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MovieInput): Promise<_MovieInput> {
...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        cast: value.cast,
        description: value.description,
        trailer: await to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.trailer),
        rating: value.rating,
        poster: await to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.poster)
    };
}
